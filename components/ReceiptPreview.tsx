      ...
      >
        ...
        >
          <div
            ...
            style={{ gap: "0.5rem 2rem", marginBottom: "2rem" }}
          >
            <div className="flex">
          ...
          >
            <div
              className="grid grid-cols-2"
              style={{ gap: "1rem", marginBottom: "0.25px" }}
            >
              <div className="flex">
                <span className="text-gray-600 whitespace-nowrap mr-2">
          ...
          <div
            className="grid grid-cols-2"
            style={{ gap: "3rem", marginTop: "4.5rem" }}
          >
          ...
          >
            <div
              className="border-t border-gray-400 inline-block"
              style={{
                paddingTop: "0.25rem",
